...
var Initializer_1 = require("./components/Initializer/Initializer");
var PluginIcon_1 = __importDefault(require("./components/PluginIcon"));
var permissions_1 = __importDefault(require("./utils/permissions"));
        ...
        app.addMenuLink({
            ...
            Component: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, Promise.resolve().then(function () { return __importStar(require("./pages/App")); })];
                        case 1:
                            component = _a.sent();
                            return [2, component];
                    }
            ...
            permissions: permissions_1.default.main,
        });
        app.createSettingSection({
            id: pluginId_1.default,
            intlLabel: {
                id: (0, getTrad_1.default)("SettingsNav.section-label"),
                defaultMessage: "Firebase-Auth Plugin",
            },
        }, [
            {
                intlLabel: {
                    id: (0, getTrad_1.default)("Settings.firebase-auth.plugin.title"),
                    defaultMessage: "Settings",
                },
                id: "settings",
                to: "/settings/".concat(pluginId_1.default),
                Component: function () {
                    return __awaiter(this, void 0, void 0, function () {
                        var component;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4, Promise.resolve().then(function () { return __importStar(require("./pages/Settings")); })];
                                case 1:
                                    component = _a.sent();
                                    return [2, component];
                            }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        locales = app.locales;
                        return [4, Promise.all(locales.map(function (locale) {
                    ...
                    case 1:
                        ...
                        return [2, Promise.resolve(importedTrads)];
                }
            });
        });
    },
