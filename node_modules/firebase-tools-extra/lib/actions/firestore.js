...
function firestoreDataFromResponse(res) {
    ...
    if ((_a = res.docs) === null || _a === void 0 ? void 0 : _a.length) {
        return res.docs.map(function (docSnap) { return (tslib_1.__assign(tslib_1.__assign({}, docSnap.data()), { 
 ...
 */
function firestoreGet(actionPath, options) {
        ...
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    ref = utils_1.slashPathToFirestoreRef(fbInstance.firestore(), actionPath, options);
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 6, , 7]);
                ...
                case 2:
                    ...
                    return [4 /*yield*/, utils_1.writeFilePromise(process.cwd() + "/" + options.output, JSON.stringify(dataToOutput, null, 2))];
                case 3:
                    // Write results to file at path provided in options.output
                    _b.sent();
                    return [3 /*break*/, 5];
                ...
                case 6:
                    err_1 = _b.sent();
                    logger_1.error("Error with firestore:get at path \"" + actionPath + "\": ", err_1.message);
                    throw err_1;
 ...
 */
function firestoreWrite(action, actionPath, filePath, options) {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (typeof ref[action] !== 'function') {
                        ...
                        logger_1.error(missingActionErr);
                ...
                case 3:
                    err_2 = _b.sent();
                    logger_1.error("Error with " + action + " at path \"" + actionPath + "\": ", err_2.message);
                    throw err_2;
...
exports.firestoreWrite = firestoreWrite;
/**
 ...
 */
function firestoreDelete(actionPath, options) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (actionPath.split('/').length % 2) {
                        return [2 /*return*/, utils_1.deleteFirestoreCollection(fbInstance.firestore(), actionPath, (options === null || options === void 0 ? void 0 : options.batchSize) || 200)];
                    }
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                ...
                case 3:
                    err_3 = _b.sent();
                    logger_1.error("firestore:delete at path \"" + actionPath + "\": ", err_3.message);
                    throw err_3;
                case 4: return [2 /*return*/];
            }
        });
